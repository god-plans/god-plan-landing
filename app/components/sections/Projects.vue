<template>
  <section id="projects" class="projects-section py-20 bg-gray-50 dark:bg-gray-900">
...
const projects = [
  {
    ...
    demo: 'https://demo.god-panel-nuxt.vercel.app',
    docs: '/docs/nuxt',
    github: 'https://github.com/god-plan/god-panel-nuxt',
