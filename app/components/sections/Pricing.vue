<template>
  <section id="pricing" class="pricing-section py-20 bg-gray-50 dark:bg-gray-800">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div
          ...
          :key="key"
          :class="[
            'pricing-card  dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300',
        ...
        >
          <div class="text-center mb-6">
            ...
            <div class="text-4xl font-bold text-indigo-600 mb-2">
              {{ plan.price }}
              <span class="text-lg text-gray-500 dark:text-gray-400">{{ plan.period }}</span>
            </div>
      ...
      <div class="mt-20 max-w-4xl mx-auto">
        ...
        <div class="space-y-6">
          <div
            ...
            :key="key"
            class="dark:bg-gray-900 rounded-lg p-6 shadow"
          >
